...
public:
   ...
   *
   * This operator adds the corresponding 'a' and 'b' values of two Algebra
   * objects and returns a new Algebra object with the result.
   *
   * @param obj The Algebra object to be added.
   * @return A new Algebra object containing the sum of 'a' and 'b' values.
   */
  friend Algebra operator+(const Algebra &obj1, const Algebra &obj2) {
    return Algebra(obj1.a + obj2.a, obj1.b + obj2.b);
  }

  /**
   * @brief Overloaded equality operator for Algebra objects.
   *
   * This operator checks if the 'a' and 'b' values of two Algebra objects are
   * equal.
   *
   * @param obj The Algebra object to compare with.
   * @return true if the 'a' and 'b' values of both objects are equal, false
   * otherwise.
   */
  friend bool operator==(const Algebra &obj1, const Algebra &obj2) {
...
int main() {
  Algebra obj1(1, 2), obj2(1, 2), obj3(7, 8);
  if (obj1 == obj2) {
